...
def call_extraction_api(file, page_no):
    try:
        ...
        resp = requests.post(f"{API_BASE}/api/intake/extract_page", files=files, data=data)
...
if st.session_state["intake_results"]:
    ...
    # Visual styling for confidence
    # (Streamlit data editor allows for some interaction)
